...
//    const userAvatars = [avatar1, avatar2, avatar3, avatar4];
    ...
    return (
        <React.Fragment>
            <div className="col-lg-6 d-none d-lg-flex align-items-center justify-content-center bg-dark text-white auth-left-image-banner">
                <div className="position-absolute bottom-0 start-0 p-4">
                    ...
                    <div className="mb-4">
                        <h2 className="text-2xl font-semibold mb-2">Very Good Works are waiting for you. Login now.</h2>
                    ...
                    <div className="d-flex items-center align-items-center">
                        ...
                        <div className="avatar-group-item">
                            ...
                            <img src={avatar1} className="rounded-circle avatar-xs" alt="Avatar 1" />
                            </a>
                        </div>
                        <div className="avatar-group-item">
                            <a className="d-inline-block" id="member4" href="#">
                            <img src={avatar2} className="rounded-circle avatar-xs" alt="Avatar 2" />
                            </a>
                        </div>
                        <div className="avatar-group-item">
                        ...
                        <div className="avatar-group-item">
                            ...
                            <img src={avatar3} className="rounded-circle avatar-xs" alt="Avatar 3" />
                            </a>
                        </div>
                        </div>
