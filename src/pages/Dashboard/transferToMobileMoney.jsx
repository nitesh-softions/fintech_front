...
const transferToMobileMoney = props => {
  ...
  //meta title
  document.title = "Ezipay | Transfer To Mobile Money";
        ...
        <Container fluid>
          <Row className="h-100">
            <Col className="d-flex flex-column">
              <h2 className="mb-3">Transfer To Mobile Money</h2>
...
transferToMobileMoney.propTypes = {
  t: PropTypes.any,
  chartsData: PropTypes.any,
  onGetChartsData: PropTypes.func,
};

export default withTranslation()(transferToMobileMoney);
